...
<div class="container">
	...
	<div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="Controller/c_add_workout.php" name="myform">

          <div class="form-group">
            <label class="col-lg-3 control-label">Workout:</label>
            <div class="col-lg-8">
	 ...
	 <label class="col-lg-3 control-label" for="Upload photo">Upload photo:</label>
	  <div class="col-md-4">
	  <input id="Upload photo" name="Uploadphoto" class="input-file" type="file" required>
	  </div>
	</div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="submit" class="btn btn-primary" name="submit"  value="Add Workout" >
              <span></span>
