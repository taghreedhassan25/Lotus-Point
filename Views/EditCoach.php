...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container-fluid">
   ...
   <li ><a href="Coachpage.php" class="scroll"><span>Services</span></a></li>
   <li class="active"  ><a href="EditCoach.php" class="scroll"><span>Edit profile</span></a></li>
...
$con = mysqli_connect("localhost","root","");
 ...
 $name = $age = $weight = $height = "";
  if (isset($_SESSION["user_id"]))
  {
    ...
    if ($id != -1)
    {
      $sql_select = "Select * from coach_info where coach_ID =".$id;
...
<div class="container">
  ...
  <div class="row">
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="Controller/c_edit_coach_profile.php" name="myform">
