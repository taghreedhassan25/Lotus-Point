            ...
            var timeCountDown = {
                ...
                setHtml: function(time){
                    ...
                    if(_startLeftTime > 0){
            			...
            			if(_endLeftTime > 0){
                            $(v).html([
            					'<li class="item"><i class="day">'+_day+'</i><span>days</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="hour">'+_hour+'</i><span>hours</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="minute">'+_minite+'</i><span>minutes</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="second">'+_second+'</i><span>seconds</span></li>',
            					'<li class="blank">:</li>',
            					'<li class="item"><i class="ms">'+_ms+'</i><span>millisec</span></li>'
            				].join(' '));
